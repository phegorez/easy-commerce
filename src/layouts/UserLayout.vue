        ...
        <div class="navbar bg-base-100">
            ...
            <div class="flex-none">
                <div class="form-control">
                    <input v-model="searchText" @keyup="handleSearch" type="text" placeholder="Search" class="input input-bordered w-24 md:w-auto" />
                </div>
                ...
                <button class="btn btn-ghost" v-if="!isLoggedIn" @click="login">LOGIN</button>
                <div class="dropdown dropdown-end" v-else>
                    ...
                    <ul tabindex="0"
                        ...
                        <li><RouterLink :to="{ name : 'profile'}">Profile</RouterLink>
                        </li>
